Title: Response
Description: Manage the HTTP JSON response for the REST API.
...
By default a `Response` is valid and has the HTTP status code `200`.

*Note: Controllers only process valid responses.*
